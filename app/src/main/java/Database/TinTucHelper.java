...
public class TinTucHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(sql);
        sql = "INSERT INTO Danhsachtt(image, title, comment) VALUES ('tintuc_3', 'PASSIO BARISTA CHAMPIONSHIP 2020 ĐÃ CHÍNH THỨC KHỞI TRANH','Đấu trường Passio Barista ChamPionShip 2020 đã chính thức khởi động vào sáng 31/10/2020')";
        sqLiteDatabase.execSQL(sql);
